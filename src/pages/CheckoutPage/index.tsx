    ...
    <div className="flex flex-col lg:flex-row p-6 space-y-6 lg:space-y-0 lg:space-x-8 max-w-5xl mx-auto">
      ...
      <div className="w-full lg:w-1/2 space-y-4">
        ...
        <InputField 
          ...
          options={["Sri Lanka", "United States", "Canada", "Australia", "United Kingdom"]}
        />
        ...
        <InputField 
          ...
          options={["Western Province", "Central Province", "Southern Province", "Northern Province", "Eastern Province"]}
        />
        <InputField label="Email Address" />
        <InputField label=" " placeholder="Additional information" className="mt-10" />
      </div>
