      ...
      <section>
        ...
        <div className="flex flex-col lg:flex-row items-start gap-12 p-6 mt-5">
            ...
            <div className="grid grid-cols-5 gap-4">
              <div className="hidden md:grid col-span-1 space-y-4">
                ...
                <Image
                  ...
                  onClick={() => setMainImage(product?.products_images.images[1])}
                />
                <Image
                  ...
                  unoptimized
                  className="w-full h-auto mx-auto object-cover rounded-lg cursor-pointer border"
                  onClick={() => setMainImage(product?.products_images.images[2])}
                />
                <Image
                  ...
                  unoptimized
                  className="w-full h-auto mx-auto object-cover rounded-lg cursor-pointer border"
                  onClick={() => setMainImage(product?.products_images.images[3])}
                />
                <Image
                  ...
                  unoptimized
                  className="w-full h-auto mx-auto object-cover rounded-lg cursor-pointer border"
                  onClick={() => setMainImage(product?.products_images.images[4])}
                />
              </div>
              {/* Main Image */}
          ...
          <div className="lg:w-1/2 space-y-6">
            <h1 className="font-bold text-[42px] lg:text-left text-center
            ">{product?.name}</h1>
