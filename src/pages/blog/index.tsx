...
const Blogs = () => {
  ...
  return (
    <>
      <Header />
      <HeadImage link="Blog" title="Blog" />
      {/* Main Container */}
      <section className="container flex p-4 mx-auto">
        ...
        <div className="mt-8 hidden sm:grid grid-cols-1 sticky top-0 h-max ">
          ...
          <div className="">
            <input
              className="w-[311px] h-[48px] border border-gray-300 rounded-lg pl-4"
              type="text"
              name=""
              id=""
              placeholder="Search"
            ...
            <div className="">
              <ul className="space-y-8 mt-8 m-8">
                <li>
                  <h2 className="font-bold mt-3 text-[24px]">Categories</h2>
                </li>
          ...
          <div className="m-6 space-y-8">
            ...
            <div className="flex mt-4 space-x-3 ">
              ...
              <div>
                <h1 className="font-bold text-sm w-[119px]">
            ...
            <div className="flex mt-4 space-x-3">
              ...
              <div>
                <h1 className="font-bold text-sm w-[139px]">
